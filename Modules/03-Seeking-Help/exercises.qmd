...
The first command returns a numeric vector. The second is a character vector. The third is also a character vector because it includes a character value.
...
sep controls how the terms are pasted together. collapse controls how the results are pasted together.
